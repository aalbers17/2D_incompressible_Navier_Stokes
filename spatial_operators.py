...
# create DDx:
# def create_DDx_operator(Dx,Xc,pressureCells_Mask,boundary_conditions="Homogenous Neumann"):
#
...
# 	# inv_dxc_central = inv_DxC[ii_center]
# 	inv_dxc_east    = inv_DxE[ii_center]
# 	DDx[ii_center,ii_east]   += inv_dxc_east
...
#  	# inv_dxc_central = inv_DxC[ii_center]
#  	inv_dxc_west    = inv_DxW[ii_center]
#  	DDx[ii_center,ii_west]   += inv_dxc_west
...
# 		# inv_dxc_central = inv_DxC[ii_center]
# 		inv_dxc_east    = inv_DxE[ii_center]
# 		DDx[ii_center,ii_center]  -= 2.*inv_dxc_east
# 		# for every east node that is 'just' outside domain
# 		west_node_mask = (iW==-1)&(iC!=-1)
# 		ii_center = iC[west_node_mask]
# 		# inv_dxc_central = inv_DxC[ii_center]
# 		inv_dxc_west    = inv_DxW[ii_center]
# 		DDx[ii_center,ii_center]  -= 2.*inv_dxc_west
...
# 		# inv_dxc_central = inv_DxC[ii_center]
# 		inv_dxc_east    = inv_DxE[ii_center]
# 		DDx[ii_center,ii_center]  -= 1.*inv_dxc_east
#         DDx[ii_center,]
# 		# for every east node that is 'just' outside domain
# 		west_node_mask = (iW==-1)&(iC!=-1)
# 		ii_center = iC[west_node_mask]
# 		# inv_dxc_central = inv_DxC[ii_center]
# 		inv_dxc_west    = inv_DxW[ii_center]
# 		DDx[ii_center,ii_center]  -= 1.*inv_dxc_west
...
# 	return DDx
#
# def create_DDy_operator(Dy,Yc,pressureCells_Mask,boundary_conditions="Homogenous Neumann"):
#
#     possible_boundary_conditions = ["Homogeneous Dirichlet","Homogeneous Neumann"]
#
#     if not(boundary_conditions in possible_boundary_conditions):
...
# 	# quit()
# 	# inv_DxC = 1./Dxc[jj_C,ii_C]
# 	# inv_DxE = 1./(Yc[jj_C,ii_C+1]-Yc[jj_C,ii_C])
#  	# inv_DxW = 1./(Yc[jj_C,ii_C]-Yc[jj_C,ii_C-1])
#     inv_DyS = 1./(Yc[jj_C,ii_C]-Yc[jj_C-1,ii_C])
#     inv_DyN = 1./(Yc[jj_C+1,ii_C]-Yc[jj_C,ii_C])
# 	# inv_DxC = 1./(Xc[jj_C,ii_C]-Xc[jj_C,ii_C])
#
...
#     DDy[ii_center,ii_south]   += inv_dxc_south
...
#     DDy[ii_center,ii_north]   += inv_dxc_north
...
# 		# inv_dxc_central = inv_DxC[ii_center]
#         inv_dxc_north    = inv_DyN[ii_center]
#         DDy[ii_center,ii_center]  -= 2.*inv_dxc_north
# 		# for every east node that is 'just' outside domain
#         south_node_mask = (iS==-1)&(iC!=-1)
#         ii_center = iC[south_node_mask]
# 		# inv_dxc_central = inv_DxC[ii_center]
#         inv_dxc_south    = inv_DyS[ii_center]
#         DDy[ii_center,ii_center]  -= 2.*inv_dxc_south
# 		# DDx[ii_center,ii_center]  -= 2.*inv_dxc_central
#
# 	return DDy
